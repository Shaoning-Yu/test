		...
		<div class="stui-pannel_bd clearfix">
			<ul class="stui-link__pic clearfix">
				<li class="col-md-7 col-sm-4 col-xs-3">
					<a href="http://www.akhu.cc/" target="_blank" title=""> <img src="<?php echo $mkcms_domain;?>template/<?php echo $mkcms_bdyun;?>/img/logo/qq.png"/> </a>
				</li>
				<li class="col-md-7 col-sm-4 col-xs-3">
					<a href="http://18jj.xyz/" target="_blank" title=""> <img src="<?php echo $mkcms_domain;?>template/<?php echo $mkcms_bdyun;?>/img/logo/youku.png"/> </a>
				</li>
				<li class="col-md-7 col-sm-4 col-xs-3">
					<a href="http://cx.dainb.cc" target="_blank" title=""> <img src="<?php echo $mkcms_domain;?>template/<?php echo $mkcms_bdyun;?>/img/logo/iqiyi.png"/> </a>
				</li>
				<li class="col-md-7 col-sm-4 col-xs-3">
					<a href="http://mm.dainb.cc" target="_blank" title=""> <img src="<?php echo $mkcms_domain;?>template/<?php echo $mkcms_bdyun;?>/img/logo/sohu.png"/> </a>
				</li>
				<li class="col-md-7 col-sm-4 col-xs-3">
					<a href="http://xn.dainb.cc" target="_blank" title=""> <img src="<?php echo $mkcms_domain;?>template/<?php echo $mkcms_bdyun;?>/img/logo/mg.png"/> </a>
				</li>
				<li class="col-md-7 col-sm-4 col-xs-3">
					<a href="http://azyh.36yunhu.cn" target="_blank" title=""> <img src="<?php echo $mkcms_domain;?>template/<?php echo $mkcms_bdyun;?>/img/logo/pptv.png"/> </a>
				</li>
				<li class="col-md-7 col-sm-4 col-xs-3">
					<a href="http://wx.abccq.cn/" target="_blank" title=""> <img src="<?php echo $mkcms_domain;?>template/<?php echo $mkcms_bdyun;?>/img/logo/tudou.png"/> </a>
				</li>
				<li class="col-md-7 col-sm-4 col-xs-3">
					<a href="http://kuaishou-1.com/" target="_blank" title=""> <img src="<?php echo $mkcms_domain;?>template/<?php echo $mkcms_bdyun;?>/img/logo/letv.png"/> </a>
				</li>
				<li class="col-md-7 col-sm-4 col-xs-3">
					<a href="http://www.36mz.xyz" target="_blank" title=""> <img src="<?php echo $mkcms_domain;?>template/<?php echo $mkcms_bdyun;?>/img/logo/ku6.png"/> </a>
				</li>
				<li class="col-md-7 col-sm-4 col-xs-3">
					<a href="http://kk25.cn/" target="_blank" title=""> <img src="<?php echo $mkcms_domain;?>template/<?php echo $mkcms_bdyun;?>/img/logo/wasu.png"/> </a>
				</li>
				<li class="col-md-7 col-sm-4 col-xs-3">
					<a href="http://kk25.xyz/" target="_blank" title=""> <img src="<?php echo $mkcms_domain;?>template/<?php echo $mkcms_bdyun;?>/img/logo/kankan.png"/> </a>
				</li>
				<li class="col-md-7 col-sm-4 col-xs-3">
					<a href="http://3gh.cc/" target="_blank" title=""> <img src="<?php echo $mkcms_domain;?>template/<?php echo $mkcms_bdyun;?>/img/logo/baofeng.png"/> </a>
				</li>			
				<li class="col-md-7 col-sm-4 col-xs-3">
					<a href="http://qq.dainb.cc/" target="_blank" title=""> <img src="<?php echo $mkcms_domain;?>template/<?php echo $mkcms_bdyun;?>/img/logo/fengxing.png"/> </a>
				</li>															
				<li class="col-md-7 col-sm-4 col-xs-3">
					<a href="http://qq.kk25.xyz/" target="_blank" title=""> <img src="<?php echo $mkcms_domain;?>template/<?php echo $mkcms_bdyun;?>/img/logo/1905.png"/> </a>
				</li>
			</ul>
		</div>
	</div>
